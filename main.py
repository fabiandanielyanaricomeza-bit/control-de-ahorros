...
def main(page: ft.Page):
    ...
    # Permitir que el contenido se pueda desplazar si la pantalla del celular es pequeña
    ...
    # Eliminamos el alignment conflictivo aquí. 
    # El centrado lo manejará la propia página y la columna.
